...
if (num < 0) and (num % 2 == 0): 
    print(f'{num} является чётным, отрицательным числом. ')
elif (num < 0) and (num % 2 != 0):
    print(f'{num} является не чётным, отрицательным числом. ')   
elif (num > 0) and (num % 2 != 0):
    print(f'{num} является не чётным, положительным числом. ')
elif (num >  0) and (num % 2 == 0):
    print(f'{num} является чётным, положительны числом. ' )
else:
    print(f'{num} является нулевым числом. ')